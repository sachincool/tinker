...
export default function AboutPage() {
  ...
  const skills = [
    { name: "Kubernetes", icon: "☸️", category: "Infrastructure" },
      ...
      <section className="relative py-12 overflow-hidden">
        ...
        <div className={`text-center space-y-6 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            {" "}— Infrastructure Wizard 🧙‍♂️ | Chaos Engineer | Professional Server Whisperer
          </p>
        ...
        <Card className="bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border-2">
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <br />
              <span className="text-xs">(Binary says: &quot;DC Sucks&quot; — A developer&apos;s truth)</span>
            </p>
          </CardContent>
        </Card>
      </section>
